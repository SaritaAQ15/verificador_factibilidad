"""
Modelos de Dominio y Estructuras de Datos
---------------------------------------------------
...
class ConfiguracionOperativa:
    ...
    duracion_visita_min: float = 30.0           # Actualizado de 24.0 a 30.0 min
    ...
    tolerancia_epsilon: float = 1e-6
    num_vans_requeridas: int = 3
    hotel_id: int = 0
